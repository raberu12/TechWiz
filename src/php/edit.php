...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $id = isset($_POST["id"]) ? $_POST["id"] : null; // Check if "id" exists in the $_POST array
    $name = $_POST["name"];
    $email = $_POST["email"];
    $phone = $_POST["phone"];
    ...
    if (empty($name) || empty($email) || empty($phone) || empty($address)) {
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                ...
                $error_msg = "Failed to update client: " . $stmt->error;
            }
            ...
            $error_msg = "Failed to prepare statement: " . $connection->error;
        }
